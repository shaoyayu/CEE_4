...
<div class="container" style="margin-top: 10%;">
    <div class="row" style="margin: 10px;">
        ...
        <div class="col-sm-10">
            <h1>用户登录<span style="color: red;">${ages}</span></h1>
        </div>
    </div>
    <form class="form-horizontal" action="${pageContext.request.contextPath}/loginSave.do" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8">
                <div class="input-group">
                    <input type="text" class="form-control" name="token" placeholder="输入验证码">
                    <span class="input-group-btn">
